// vibecodea.js - Juego infinito completo
const config = {
    type: Phaser.AUTO,
    width: 800,
    height: 600,
...
function update(time, delta) {
    ...
    if (cursors.left.isDown) { player.body.setVelocityX(-200); player.setScale(1,1); }
    else if (cursors.right.isDown) { player.body.setVelocityX(200); player.setScale(-1,1); } // reflejo derecha
